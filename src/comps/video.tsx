...
const VideoBox: FC<VideoBoxProps> = ({
    ...
    const borderColor = isSpeaking ? theme.semanticColors.errorText : theme.palette.neutralLighter
    return (
        <div
            ref={containerRef}
                ...
                <div className={classes.overlay}>
                    ...
                    >
                        <Persona
                            ...
                            initialsColor={stream.empty ? PersonaInitialsColor.gray : undefined}
