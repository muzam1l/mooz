...
export const useMediaGridSizes = ({
    ...
    const calculate = useCallback(() => {
        ...
        const pinnedContainerWidth =
            isDesktop && gridItems
                ...
                : containerWidth
        const pinnedContainerHeight = isDesktop ? containerHeight : containerHeight * 0.5
        const gridContainerWidth = hasPinnedItem
            ? isDesktop
                ? containerWidth - pinnedContainerWidth
                : containerWidth
            : containerWidth
        const gridContainerHeight = isDesktop ? containerHeight : containerHeight * 0.5
    ...
    }, [container?.offsetHeight, container?.offsetWidth, gridItems, hasPinnedItem])
