...
export const Media: FC = () => {
    ...
    const { pinnedContainerWidth, gridContainerWidth, gridItemWidth, gridItemHeight } =
        useMediaGridSizes({
    ...
    return (
        <div ref={containerRef} className={classes.container}>
            {/* Pinned View */}
            {!!pinnedItem && (
                <div style={{ width: pinnedContainerWidth }} className={classes.pinnedContainer}>
                    <VideoBox {...pinnedItem} />
                </div>
            )}
            {/* Grid view */}
            {!!gridItems.length && (
                ...
                >
                    <div style={{ alignContent }} className={classes.gridInner}>
                        {gridItems.map(props => (
                            <div
                                style={{ width: gridItemWidth - 10, height: gridItemHeight - 10 }}
                                key={props.stream.id}
                            >
                                <VideoBox {...props} />
                            </div>
            ...
            <div className={classes.displayMediaContainer} id="display-media-container" />
